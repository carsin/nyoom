        ...
        <ion-grid>
          <ion-row>
            <ion-col size-md="6" offset-md="3">
              ...
              <ion-button expand="block" @click="createPart">List Part</ion-button>
            </ion-col>
          </ion-row>
        </ion-grid>
  ...
  try {
    if (user) {
      ...
      if (docSnap.exists()) {
        ...
        toast.value = { isOpen: true, message: 'Part listed successfully!', color: "success"};
        router.push("/market");
      } else {
    ...
    toast.value = { isOpen: true, message: "Error creating part: " + error.message, color: 'danger' };
  }
};
